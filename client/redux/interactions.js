...
//POLY MAINNET
const crowdFundingContractAddress =
  '0x15Db1661eE8b444BCE3B45fDf93e7fe11faa0831';
...
export const getAllFunding = async (CrowdFundingContract, web3, dispatch) => {
  ...
  const fundingProjectList =
    await CrowdFundingContract.methods.returnAllProjects();
  console.log('funding project list', await fundingProjectList.call());
  // .call();
